...
def getdata(transform={'train':None, 'val':None}, kwargs={'num_workers': 20, 'pin_memory': True}):
  ...
  traindata = dset.ImageFolder(datapath+'Train', transform=transform['train'])
  train4valdata = dset.ImageFolder(datapath+'Train', transform=transform['val'])
  valdata = dset.ImageFolder(datapath+'Val', transform=transform['val'])
